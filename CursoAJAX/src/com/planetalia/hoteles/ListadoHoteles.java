...
@WebServlet("/listadoHoteles")
public class ListadoHoteles extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if ( tipo == 2)
				ps = con.prepareStatement("select * from hoteles where categoria >= ? and preciodoble between ? and ?");
			else
				ps = con.prepareStatement("select * from hoteles where categoria >= ? and precioindividual between ? and ?");
